...
public partial class InteractionOffer : Resource
{
    ...
    /// <summary>Gets or sets the future target reservation group for this offer.</summary>
    [Export]
    public StringName TargetConcurrencyGroup { get; set; } = new();

    /// <summary>Gets or sets the future presentation while this target is reserved by this requester.</summary>
    [Export]
    public GameplayActionUnavailableKind WhenReservedBySelf { get; set; } =
        GameplayActionUnavailableKind.Blocked;

    /// <summary>Gets or sets the future presentation while this target is reserved by another requester.</summary>
    [Export]
